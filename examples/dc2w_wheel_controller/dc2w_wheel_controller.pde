...
double turnRadius = 12.2; //Turn radius is the distance for one wheel to another, it is the shaft length, in centimeters
...
Continuous2Wheels c2w(&rightWheel, &leftWheel, wheelRadius, turnRadius);
...
void loop(){
  ...
  delay(4000);
  c2w.turn(90); // Make a right bent with 90°
  delay(4000);
  c2w.reverse(45); // Move the robot backward speed of 45
  delay(4000);
  c2w.turn(-90); // Make a left bent with 90°
  delay(4000);
